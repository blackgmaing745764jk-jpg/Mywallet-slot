    ...
    <head>
        ...
        <style>
            * { box-sizing: border-box; }
            ...
            .user-info { color: #94a3b8; font-size: 12px; background: #0f172a; padding: 6px 12px; border-radius: 20px; border: 1px solid #334155; display: flex; align-items: center; gap: 5px; }
            ...
            .modal-content { background: #1e293b; border: 1px solid #475569; width: 100%; max-width: 380px; border-radius: 16px; padding: 20px; display: flex; flex-direction: column; gap: 12px; }
    ...
    <body>
        ...
        <div class="modal-overlay" id="walletModal">
            <div class="modal-content">
                ...
                <input type="number" id="modalAmount" placeholder="ပမာဏထည့်ပါ (Ks)" style="width:100%; padding:10px; background:#090d16; border:1px solid #475569; color:#fff; border-radius:8px; outline:none;">
        ...
        <script>
            ...
            function openModal(type) {
                ...
                document.getElementById('modalTitle').innerText = type === 'deposit' ? 'ငွေသွင်းရန်' : 'ငွေထုတ်ယူရန်';
            ...
            function submitWallet() {
                ...
                if(currentModalType === 'withdraw' && balance < amt) { alert('ငွေလက်ကျန် မလုံလောက်ပါ။'); return; }
                
                if(currentModalType === 'deposit') balance += amt;
                else balance -= amt;

                updateBalanceUI();
                closeModal();
                alert(currentModalType === 'deposit' ? 'ငွေသွင်းမှု အောင်မြင်ပါသည်။' : 'ငွေထုတ်ယူမှု အောင်မြင်ပါသည်။');
            }
