...
let db = {
    ...
    requests: [],
    withdraws: [],
    activeBets: [] // လောင်းကြေးများကို အချိန်ကုန်မှ စစ်ဆေးရန် သိမ်းဆည်းမည့်နေရာ
};
    ...
    <body>
        ...
        <script>
            ...
            setInterval(() => {
                ...
                if(timeLeft <= 0) {
                    // အချိန်ကုန်တဲ့အခါ လောင်းကြေးတင်ထားရင် ရလဒ်ကို တောင်းခံမယ်
                    if(hasBetThisRound) {
                        checkResult();
                    }
                    timeLeft = 30;
            ...
            function placeBet(id) {
                ...
                .then(data => {
                    if(data.success) {
                        ...
                        // လောင်းပြီးတာနဲ့ မျက်နှာပြင်ကို ခဏမှိန်သွားစေရန် (disabled) လုပ်မည်
...
// 5. Bet API (ငွေလက်ကျန်ဖြတ်ပြီး သိမ်းဆည်းရန်)
app.post('/api/bet', (req, res) => {
    ...
    // Active Bets ထဲသို့ ထည့်သိမ်းမည်
...
// 6. Result Check API (အချိန်ကုန်မှ ရလဒ်ထုတ်ပေးရန်)
app.get('/api/result', (req, res) => {
    ...
    // လောင်းကြေးပြီးဆုံးပါက activeBets ထဲမှ ဖယ်ရှားမည်
    db.activeBets = db.activeBets.filter(b => b.gameId !== gameId);
