        ...
        <script>
            ...
            function startFlight(targetCrash) {
                ...
                gameInterval = setInterval(() => {
                    currentMultiplier += 0.01; // ပိုမိုနှေးကွေးစွာ တက်စေရန် 0.01x သို့ ပြောင်းထားသည်
...
// 6. Crash Bet API (အစောပိုင်း 1.xx တွေမှာ ပိုစောပေါက်အောင် ချိန်ညှိထားသည်)
app.post('/api/crash-bet', (req, res) => {
    ...
    // အရှုံးများစေရန်နှင့် စောပေါက်စေရန် Random များကို 1.00x မှ 2.00x အတွင်း ပိုကျအောင် ချိန်ညှိထားသည်
    let rand = Math.random();
    let crashAt;
    if (rand < 0.65) {
        // 65% သသောနှုန်းဖြင့် 1.00x မှ 1.50x အတွင်း စောပေါက်မည်
        crashAt = parseFloat((Math.random() * (1.5 - 1.0) + 1.0).toFixed(2));
    } else if (rand < 0.90) {
        // 25% သသောနှုန်းဖြင့် 1.51x မှ 2.20x အတွင်း ပေါက်မည်
        crashAt = parseFloat((Math.random() * (2.2 - 1.51) + 1.51).toFixed(2));
    } else {
        // ကျန်ရှိသော 10% သသောနှုန်းဖြင့်သာ မြင့်မားစွာ တက်မည်
