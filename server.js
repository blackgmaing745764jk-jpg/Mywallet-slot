...
// In-Memory Database (ဆာဗာ Restart ဖြစ်ရင်တောင် Session မပျောက်အောင် ယာယီသိမ်းဆည်းပေးခြင်း)
let db = {
    balances: { "1006": 5000 }, // စမ်းသပ်ရန် 1006 ကို ငွေ 5000 ထည့်ပေးထားသည်
    requests: [],
    withdraws: []
};
...
app.get('/home', (req, res) => {
    ...
    <body>
        ...
        <script>
            ...
            fetchBalance();
            setInterval(fetchBalance, 3000); // ၃ စက္ကန့်တစ်ကြိမ် ငွေလက်ကျန်ကို အလိုအလျောက် စစ်ဆေးပေးမည်
