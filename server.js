...
app.get('/home', (req, res) => {
    ...
    <head>
        ...
        <style>
            ...
            .logout { background: #ef4444; color: white; cursor: pointer; margin-top: 20px; font-weight: bold; width: 100%; padding: 12px; border-radius: 5px; border: none; }
        </style>
    </head>
    <body>
        <div class="container">
            <div class="header-card">
                ...
                <div class="quick-actions">
                    <a href="/deposit?id=${gameId}" class="action-btn">📥 ငွေသွင်း</a>
                    <a href="/withdraw?id=${gameId}" class="action-btn">📤 ငွေထုတ်</a>
            ...
            <div class="menu-grid">
                ...
                <a href="/deposit?id=${gameId}" class="menu-card">
                    <h4>ငွေသွင်းမှတ်တမ်း</h4>
                    <p>ပြုလုပ်ခဲ့သော ငွေသွင်းမှုများ</p>
                </a>
                <a href="/withdraw?id=${gameId}" class="menu-card">
...
// 3. Deposit Page (သီးသန့်စာမျက်နှာ)
app.get('/deposit', (req, res) => {
    ...
    <head>
        ...
        <style>
            ...
            .limit-info { font-size: 12px; color: #94a3b8; text-align: left; margin-top: 4px; }
        </style>
    </head>
    <body>
        <div class="container">
...
// 4. Withdraw Page (သီးသန့်စာမျက်နှာ)
