...
<body>
    ...
    <script>
        ...
        function clickMine(btn) {
            ...
            // ဗုံးကျမည့် ရာခိုင်နှုန်း (ဗုံးများလေ ရှုံးဖို့များလေ၊ ဇ မြင့်လေ)
        ...
        function startWingoTimer() {
            ...
            let infoEl = document.getElementById('wingoBetInfo');
            ...
            wingoTimerInterval = setInterval(() => {
                ...
                if (wingoCountdown <= 0) {
                    ...
                    setTimeout(() => {
                        ...
                        // ထပ်မံစတင်ရန် 3 စက္ကန့်ကြာလျှင် တာင်မာစဥ်အသစ်ပြန်စမည်
        ...
        function startCrush() {
            ...
            // ဇ (Multiplier) ဖြည်းဖြည်းချင်း တက်စေရန် Speed ကို ချိန်ညှိထားသည် (1.00x မှစ၍ ဖြည်းဖြည်းတက်မည်)
            ...
            crushInterval = setInterval(() => {
                ...
                // 1.00x ချက်ချင်းမကျဘဲ အနည်းငယ်မြင့်မှ ကျပန်းပျက်စီးမည့် စနစ်
                let crashProbability = 0.02 + (currentMult > 2.0 ? 0.04 : 0.01);
                if (currentMult > 1.05 && Math.random() < crashProbability) {
