...
// 7. JILI Mines Game Page (ဗုံး ၃ လုံးမှ ၈ လုံးအထိ ရွေးချယ်နိုင်သော စနစ်)
        ...
        <script>
            ...
            function clickTile(index) {
                ...
                fetch('/api/mines-click', {
                    ...
                    if(data.isBomb) {
                        // ဗုံးပေါက်လျှင် ဗုံးအားလုံးနှင့် နေရာအမှန်များကို ပေါ်ပြရန်
...
// Mines Game Backend APIs (ဗုံး ၃ မှ ၈ လုံးအထိနှင့် ဗုံးအရေအတွက်ပေါ်မူတည်၍ မြှောက်ဂဏန်းများ တိုးသွားစေရန်)
app.post('/api/mines-start', (req, res) => {
    ...
    // ကျပန်း ဗုံးနေရာများ သတ်မှတ်ခြင်း (၂၅ ကွက်ထဲမှ ရွေးရန်)
    let bombs = [];
...
app.post('/api/mines-click', (req, res) => {
    ...
    if(session.bombs.includes(tileIndex)) {
        ...
        session.hits++;
        // ဗုံးအရေအတွက် များလေ မြှောက်ဂဏန်း (Multiplier) ပိုတိုးလေ ဖြစ်စေရန် တွက်ချက်ခြင်း
