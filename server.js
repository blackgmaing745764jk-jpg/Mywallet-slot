    ...
    <script>
        ...
        function openGame(type) {
            ...
            if (type === 'fish') {
                ...
                content.innerHTML = `
                    <div style="font-size: 45px; margin-bottom: 5px;" id="aviatorPlane">🚀</div>
                    <div style="font-size: 32px; font-weight: bold; color: #38bdf8; background: #1f2937; padding: 10px 20px; border-radius: 8px; border: 1px solid #374151; margin-bottom: 12px; width: 100%; max-width: 250px; box-sizing: border-box;" id="crushMultiplier">1.00x</div>
                    
                    <div style="width: 100%; max-width: 250px; margin-bottom: 10px; text-align: left;">
                    ...
                    <button style="display: block; background: #10b981; color:white; border:none; padding:12px 25px; border-radius:8px; font-weight:bold; cursor:pointer; font-size:16px; width: 100%; max-width: 250px; margin-bottom: 8px;" id="crushStartBtn" onclick="startCrush()">စတင်မည်</button>
                    ...
                    <div style="margin-top: 8px; color: #fbbf24; font-weight: bold; font-size: 13px;">လက်ကျန်ငွေ: <span id="gameBal">${balance}</span> ကျပ်</div>
                `;
            }
        }
