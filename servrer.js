...
// 4. Win Go Game Page (ငွေလောင်းမည် ခလုတ်သာ မှိန်သွားစေရန် ပြင်ဆင်ထားသည်)
app.get('/play', (req, res) => {
    ...
    <body>
        <div class="card" id="gameCard">
            ...
            <button class="btn-bet" id="betBtn" onclick="placeBet('${gameId}')">ငွေလောင်းမည်</button>
        </div>
            ...
            function placeBet(id) {
                ...
                .then(data => {
                    if(data.success) {
                        ...
                        // ငွေလောင်းမည် ခလုတ်ကိုသာ မှိန်သွားစေရန်
